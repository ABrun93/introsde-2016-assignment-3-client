 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://webservice.soap.assignment.introsde/", wsdlLocation = "http://127.0.1.1:6903/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://webservice.soap.assignment.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.1.1:6903/ws/people?wsdl");
    ...
    public People getPeopleImplementationPort() {
        return super.getPort(new QName("http://webservice.soap.assignment.introsde/", "PeopleImplementationPort"), People.class);
    }
    ...
    public People getPeopleImplementationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.soap.assignment.introsde/", "PeopleImplementationPort"), People.class, features);
    }
