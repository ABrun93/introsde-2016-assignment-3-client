 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://webservice.soap.assignment.introsde/", wsdlLocation = "http://localhost:6903/ws/people?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:6903/ws/people?wsdl");
